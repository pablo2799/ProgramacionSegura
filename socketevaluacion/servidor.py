...
def funcion_ejecutar_inicializacion(script_inicializacion):
   ...
   """
   logging.info("Inicio ejecutar la script_inicializacion")
   ...
   logging.info("Termino de ejecutar la script_inicializacion")
...
def funcion_ejecutar_comprobacion_parametros(script_comprobacion_parametros, script_estudiante, cliente):
   ...
   logging.info("Termino de ejecutar la comprobacion parametros")
...
def funcion_ejecutar_script_alumno(script_estudiante, entradas_prueba):
   ...
   """
   logging.info("Inicio ejecutar el script del estudiante")
   cont=0
   cont_var_while=0
   resultado=""
   num_variables=1
   ...
   logging.info("Termino de ejecutar el script del estudiante")
...
def crear_socket_servidor():
   ...
   logging.info("Se creo el socket servidor")
   return mi_socket
...
def ejecutar_scripts(cliente, mutex):
   ...
   -Return
   """
   logging.info("Entro a la ejecucion de los scripts")
   ...
   logging.info("Envio las variables al cliente")
